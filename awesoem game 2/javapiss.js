...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function tick() {
        ...
        ballpointgain = new Decimal('1')
            ...
            .times(new Decimal('1').plus(new Decimal('2').pow(pupgradelist[0].divideBy(20).floor())))
        ...
        xpgain = new Decimal('1')
            ...
            .times(new Decimal('1').plus(new Decimal('2').pow(pupgradelist[1].divideBy(25).floor())))
